...
Computation times
=================
**00:01.410** total execution time for 17 files **from auto_jops_examples/chapter_2**:
...
.. container::
   ...
   * - Example
     - Time
     - Mem (MB)
   * - :ref:`sphx_glr_auto_jops_examples_chapter_2_plot_eff-kernels.py` (``plot_eff-kernels.py``)
     - 00:01.410
     - 0.0
